...
window.addEventListener 'load', (event) ->
  ...
  audio = new retro.WebAudio(new window.AudioContext())
  input = new retro.WebInput(keyBindings)
  video = new retro.WebVideo(gl, vertexShaderSource, fragmentShaderSource)
